                        ...
                        <div class="cm-col-lg-8 cm-col-md-7 cm-col-12 sm-d-none">
                            <div class="top-header-social-links d-flex align-items-center justify-content-end">
                                <ul class="topsocial-icons mr-2">
                                    <li >
                                            <img src="{{ asset('/banner') }}/follow.png" style="height: 35px;">
                                    </li>
                                    <li class="fb">
                        ...
                        <ul  class>
                            ...
                            <li
                                ...
                                <a href="<?php if(count($subMenus) > 0){ echo asset('/').$menu['menu_link']; } else { echo $menu['menu_link']; } ?>"
                                    aria-current="page" style="<?php echo ($menu['image'] != '') ?   ($menu['image'] == '0' ? 'padding: 15px 6px;' : 'padding: 0px 0px;') : 'padding: 15px 6px;' ?>">
                                    @if($menu['image'] != '') 
                                        ...
                                        <ul>
                                            ...
                                            <li class="yt">
                                                <a href="https://{{ isset($setting->youtube) ? $setting->youtube : '' }}" target="_blank">
                                                    <i class="fa fa-youtube-play"></i><span>Subscribe</span>
                                                </a>
                                            </li>
                                            <li class="wp"style="background-color: green;">
                                                <a href="https://whatsapp.com/channel/0029VajdZqv9xVJbRYtSFM3C" target="_blank">
                                                    <i class="fa fa-whatsapp"></i><span>Subscribe</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
