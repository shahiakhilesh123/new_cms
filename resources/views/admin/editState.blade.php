      ...
      <div class="container-fluid">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="{{asset('state/edit')}}/{{ $state->id }}" >
              @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="name">State Name</label>
                    <input type="text" name="name" value="{{ $state->name }}" class="form-control" id="name">
                    @error('name')
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-check">
                          <input class="form-check-input" name="home_page_status" <?php if($state->home_page_status == 1) { echo "checked"; } ?> type="checkbox">
